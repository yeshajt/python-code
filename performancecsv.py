#===Honors Assignment: creating a csv file with info from Assignment 2===#
...
for stock in stocklist:
    ...
    newfile = open("performance.csv","w")
...
for i in range(0,30):
    percent = str(performance[i][0])
    stock = performance[i][1]
    newfile.write(percent + "," + stock + "\n")
newfile.close()
